    ...
    <StepLayout title="학교를 검색해주세요" description={`정확한 답변을 하지 않으면\n불이익이 발생할 수 있습니다.`}>
      ...
      <div className="mt-7 flex flex-col gap-2">
        <Card
          ...
          className="cursor-pointer flex-row items-center justify-between border-2 border-dashed border-indigo-200 transition-colors hover:border-indigo-400"
        >
          <div className="text-sub2 text-indigo-400">학교가 목록에 없어요</div>
          <RightArrowIcon className="text-indigo-400" />
        </Card>
