  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-10 py-11.5">
      <section className="flex flex-col items-center gap-5">
        <div className="bg-primary-100 border-primary-400 text-primary-500 flex h-16 w-74.25 justify-center gap-2.5 rounded-[30px] border-2 px-7.5 py-3 text-[24px] leading-10 font-semibold">
      ...
      <section className="flex gap-5">
        ...
        <div className="border-text-100 flex h-92.75 w-82.75 flex-col items-center gap-10 rounded-[20px] border bg-[#ffffff] px-7.5 py-10">
          <img src={Register} alt="학교 동아리 목록 등록" />
          <div className="flex flex-col items-center">
